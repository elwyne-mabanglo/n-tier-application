...
<html lang="en">
    ...
    <body>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="http://stu-nginx.cms.gre.ac.uk/~me324/sowa/level4/level4Scaffolding.php">Level 4 : Portal search</a></li>
        ...
        <div class="container">
            <h3>Level 4 : Portal Search</h3>
            <form method="post" action="level4RetrieveData.php" target="_blank">
