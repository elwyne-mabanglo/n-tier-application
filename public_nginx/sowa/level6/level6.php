...
<html lang="en">
    <head>
        ...
        <script>
            ...
            function moreInformation(a, b) {
                location.href = "http://stu-nginx.cms.gre.ac.uk/~me324/sowa/level6/moreInformation.php?propertyId=" + a + "&db=" + b;
            }
        </script>
        <style>
    ...
    <body>
        ...
        <div class="container">
            <h3>Level 6 : XSLT <button data-toggle="collapse" data-target="#demo" class="btn btn-default btn-sm">Search</button></h3>
            <div id="demo" class="collapse">
                <form method="get" action="level6.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="min" name="min" value="<?php echo $min ?>">
                    </div>
                    <div class="form-group">
                        <label for="max">Max £:</label>
                        <input type="number" class="form-control" id="max" name="max" value="<?php echo $max ?>">
                    </div>
                    <div class="form-group">
                        <p>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="max" name="propertyId" value="<?php echo $propertyId ?>">
                    </div>
        ...
        $xslDoc->load('level6xsl.xsl', LIBXML_NOCDATA);
