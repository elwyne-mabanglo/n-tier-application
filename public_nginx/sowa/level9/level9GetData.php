...
$currentLocation = test_input($_GET['currentLocation']);
$distanceLimit = test_input($_GET['distanceLimit']);
...
$url = 'http://stu-nginx.cms.gre.ac.uk/~me324/sowa/level9/sort2.php?' . $queryString;
...
$xslDoc->load('level9.xsl', LIBXML_NOCDATA);
