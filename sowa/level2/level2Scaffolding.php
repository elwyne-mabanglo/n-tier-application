...
<html lang="en">
    ...
    <body>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="http://stuiis.cms.gre.ac.uk/me324/sowa/level2/level2Scaffolding.php">Level 2 : .NET web services</a></li>
        ...
        <div class="container">
            <h3>Level 2 : .NET web services</h3>
            <form method="post" action="level2RetrieveData.php" target="_blank">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="max" name="propertyId">
                </div>
